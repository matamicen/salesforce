...
BEGIN
  ...
  p_purchase_datetime := p_purchase_datetime + INTERVAL '1 millisecond';
    ...
    INSERT INTO salesforce.processed_purchases (
        purchase_id,
        user_id,
        email,
        first_name,
